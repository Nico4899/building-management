 ...
 */
public class CampusLocationBuildingSorter implements Sorter<Building> {

  @Override
  public Collection<Building> sort(Collection<Building> collection) {
    return collection.stream().sorted(Comparator.comparing(Building::getCampusLocation)).toList();
  }
}
