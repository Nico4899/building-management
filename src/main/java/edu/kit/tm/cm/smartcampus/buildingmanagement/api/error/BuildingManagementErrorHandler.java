 ...
 */
public class BuildingManagementErrorHandler<S extends Message, T extends Message> implements StreamObserver<T> {

  // Error logs? util.Logger?

  private final StreamObserver<T> grpcResponseObserver;

  public BuildingManagementErrorHandler(StreamObserver<T> grpcResponseObserver) {
