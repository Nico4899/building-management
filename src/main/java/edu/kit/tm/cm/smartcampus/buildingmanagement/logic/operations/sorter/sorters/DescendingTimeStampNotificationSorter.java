 ...
 * Notification} by newest time stamp.
 */
@AllArgsConstructor
public class DescendingTimeStampNotificationSorter implements Sorter<Notification> {

  @Override
  public Collection<Notification> sort(Collection<Notification> collection) {
    return collection.stream().sorted(Comparator.comparing(Notification::getCreationTime)).toList();
  }
}
